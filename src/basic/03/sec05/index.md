...
### 다양한 TF 정규화 기법들
단순 문서 길이가 너무 길면 모든 단어의 TF가 폭주하는 것을 막기 위해 실무에서는 단순 카운트 외에도 다양한 `Boolean 빈도(1 or 0)`, `로그 정규화(Log normalization)`, `문서 최대 빈도 대비 비율(Double normalization)` 등 파생 기법을 쓰기도 합니다.
